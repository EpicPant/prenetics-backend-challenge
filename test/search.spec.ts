...
import { initialiseDB, seedData } from '../src/component/testConnection';
import { createHttpServer } from '../src/component/testServer';
...
describe('Search', () => {
    ...
    test('will return extra fields when organisation is Circle', async () => {
        ...
        expect(response.body.included[0].attributes.id).to.not.be.undefined;
